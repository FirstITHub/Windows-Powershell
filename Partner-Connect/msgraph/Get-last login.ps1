...
#Connect to Azure AD
Connect-AzureAD -TenantID 9d1b1b22-a9e0-4852-a110-fec4fd757c6e
...
#Read more: https://www.sharepointdiary.com/2022/04/office-365-find-last-login-date-using-powershell.html#ixzz8AiR9mVyq
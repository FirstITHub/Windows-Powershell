...
# Specify the out-of-office message and start/end dates
$oomMessage = @"
<html>
<body>
<p>Beste,</p>
<br>
<p>Het volledige Arcade team geniet van een deugddoend bouwverlof. Onze kantoren zijn volledig gesloten vanaf maandag 10 juli tot en met vrijdag 28 juli. Op maandag 31 juli organiseren wij onze jaarlijkse “Arcade-dag”. Dinsdag 1 augustus staan wij opnieuw klaar om uw vragen te beantwoorden.</p>
<br>
<p>Zonnige groeten,</p>
</body>
</html>
